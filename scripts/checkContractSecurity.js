module.exports = function(callback) {
    ...
    const pauseCrowdsale = async (crowdsale, owner) => {
        let pause_crowdsale_tx = await crowdsale.pause({from: owner, gas: 100000});
    }

    const unPauseCrowdsale = async (crowdsale, owner) => {
        let unpause_crowdsale_tx = await crowdsale.unpause({from: owner, gas: 100000});
    }
